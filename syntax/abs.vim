...
" keyword definitions
syn keyword javaExternal	native module export
syn match javaExternal		"\<import\>\(\s\+static\>\)\?"
syn keyword javaError		goto const
syn keyword javaConditional	if then else case
syn keyword javaRepeat		while for do
syn keyword javaBoolean		true false
syn keyword javaConstant	True False Nil EmptyMap
syn keyword javaTypedef		this
syn keyword javaOperator	new cog
syn keyword javaType		Bool Int List Map Maybe
syn keyword javaType		Unit
